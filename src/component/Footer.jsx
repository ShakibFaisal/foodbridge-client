...
const Footer = () => {
  return (
    <footer className="bg-[#FFE7D1] text-black p-10">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-8 md:gap-0">
        ...
        <div className="flex flex-col items-start">
          <Link className="text-2xl font-extrabold flex items-center gap-1 mb-2" to="/">
            <span className="text-[#441306]">F</span>
            <span className="text-orange-400 flex items-center"><PiBowlFood />o</span>
            <span className="text-[#441306]">dBridge</span>
          </Link>
          <p className="text-sm md:text-base text-black/80">
            Share Your Extra, Help Someone Today
          </p>
        </div>
      ...
      {/* Bottom copyright */}
      <div className="mt-10 border-t border-black/20 pt-4 text-sm text-black/60 text-center">
